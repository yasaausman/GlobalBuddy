...
- [x] Define the I-20 JSON Schema for Nutrient `/extract` — the 12 fields (confidence, match_label, page, bbox, citation each) are defined and seeded; not yet validated against a real Nutrient `/extract` call (still mock-only)
